  ...
  const submit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (!data?.ok || !data?.token || !data?.user) {
        setError(data?.message ?? 'No se pudo confirmar la cuenta.');
        return;
      }
    ...
    <div className="auth-page auth-page-premium">
      ...
      <div className="auth-premium-grid">
        <div className="auth-showcase-card">
          <div className="auth-showcase-badge">Confirmación de cuenta</div>

          <h1 className="auth-showcase-title">Confirma tu correo</h1>

          <p className="auth-showcase-text">
            Antes de activar el acceso al portal, SMART RH necesita confirmar que el correo
            registrado pertenece al usuario.
          </p>
          ...
          <div className="auth-showcase-points">
            <div className="auth-showcase-point">
              ...
              <div>
                ...
                <p>Ingresa el código enviado a tu correo para activar tu cuenta.</p>
              </div>
            </div>
            ...
            <div className="auth-showcase-point">
              ...
              <div>
                ...
                <p>Después de confirmar el correo podrás acceder al portal administrativo.</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="auth-wrapper auth-wrapper-premium">
          <div className="auth-brand-block">
            ...
            <p className="auth-brand-subtitle">Verificación de cuenta</p>
          </div>

          <form className="auth-card auth-card-premium" onSubmit={submit}>
            <div className="auth-card-header">
              <div>
                <p className="auth-eyebrow">Cuenta nueva</p>
                <h2 className="auth-title">Confirmar cuenta</h2>
              </div>
            ...
            <button className="auth-submit" type="submit" disabled={loading}>
              <span>{loading ? 'Confirmando...' : 'Confirmar cuenta'}</span>
